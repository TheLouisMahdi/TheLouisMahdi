...
import{handleSupplementalControlAction,supplementalControlPages}from"./control-pages.js"
import{initDetailedTaskManager}from"./task-manager.js"
...
function mountWindows(){
  ...
  windowNode("taskmanager","Windows Task Manager","taskmanager",`<div class="taskmgr-menu"><button>File</button><button>Options</button><button>View</button><button>Windows</button><button>Help</button></div><div class="taskmgr-tabs"><button class="active" data-taskmgr-tab="applications">Applications</button><button data-taskmgr-tab="processes">Processes</button><button data-taskmgr-tab="services">Services</button><button data-taskmgr-tab="performance">Performance</button><button data-taskmgr-tab="networking">Networking</button><button data-taskmgr-tab="users">Users</button></div><div class="taskmgr-table" id="taskManagerList"></div><div class="taskmgr-actions"><span id="taskManagerStatus">Processes: 31 · CPU Usage: 7% · Physical Memory: 34%</span><span><button id="taskManagerNewTask">New Task...</button><button id="endTask">End Task</button></span></div>`,`taskmanager-window`)
  ...
  windowNode("systeminfo","System","system",`<div class="system-properties"><header><span>${icon("windows")}</span><div><h2>Windows 7 Professional</h2><p>Copyright © 2009 Microsoft Corporation</p></div></header><section><h3>System</h3><dl><dt>Manufacturer</dt><dd>EKA</dd><dt>Model</dt><dd>EKA Notebook 7</dd><dt>Processor</dt><dd>EKA Virtual x86 Processor</dd><dt>Installed memory (RAM)</dt><dd>4.00 GB</dd><dt>System type</dt><dd>32-bit Operating System</dd><dt>Computer name</dt><dd>EKA-PC</dd></dl></section><footer>Windows is activated · Product ID: EKA-7600-GITHUB</footer></div>`,`system-window`)
...
const CONTROL_CATEGORIES=[
  {id:"system-security",name:"System and Security",icon:"system",links:[["action-center","Review your computer's status"],["firewall","Check firewall status"],["system","View amount of RAM and processor speed"],["windows-update","Check for updates"],["power-options","Change battery settings"],["backup","Back up your computer"],["administrative-tools","Administrative Tools"],["windows-defender","Scan for spyware"],["troubleshooting","Find and fix problems"],["recovery","Restore your computer"]]},
  {id:"network-internet",name:"Network and Internet",icon:"ie",links:[["network-sharing","View network status and tasks"],["homegroup","Choose homegroup and sharing options"],["internet-options","Internet Options"],["remoteapp","RemoteApp and Desktop Connections"]]},
  {id:"hardware-sound",name:"Hardware and Sound",icon:"devices",links:[["devices","View devices and printers"],["autoplay","Play CDs or other media automatically"],["sound","Adjust system volume"],["power-options","Change battery settings"],["display","Adjust screen resolution"],["mouse","Mouse"],["keyboard","Keyboard"],["color-management","Color Management"],["mobility","Windows Mobility Center"],["tablet-settings","Tablet PC Settings"],["pen-touch","Pen and Touch"],["phone-modem","Phone and Modem"],["infrared","Infrared"],["biometric","Biometric Devices"]]},
  {id:"programs",name:"Programs",icon:"folder",links:[["programs-features","Uninstall a program"],["default-programs","Default Programs"],["desktop-gadgets","Desktop Gadgets"],["windows-features","Turn Windows features on or off"],["windows-anytime","Windows Anytime Upgrade"]]},
  {id:"user-accounts",name:"User Accounts and Family Safety",icon:"system",links:[["user-account","Add or remove user accounts"],["parental-controls","Set up parental controls for any user"],["credential-manager","Credential Manager"],["windows-cardspace","Windows CardSpace"]]},
  {id:"appearance",name:"Appearance and Personalization",icon:"paint",links:[["personalization","Change the theme"],["display","Adjust screen resolution"],["desktop-gadgets","Desktop Gadgets"],["taskbar","Taskbar and Start Menu"],["folder-options","Folder Options"],["fonts","Fonts"]]},
  ...
  {id:"ease-access",name:"Ease of Access",icon:"keyboard",links:[["ease-center","Let Windows suggest settings"],["speech-recognition","Speech Recognition"],["display-access","Optimize visual display"]]}
]

const CONTROL_ITEMS=[
  ["action-center","Action Center","system"],["administrative-tools","Administrative Tools","control"],["autoplay","AutoPlay","media"],["backup","Backup and Restore","drive"],["biometric","Biometric Devices","devices"],["bitlocker","BitLocker Drive Encryption","drive"],["color-management","Color Management","paint"],["credential-manager","Credential Manager","system"],["date-time","Date and Time","run"],["default-programs","Default Programs","system"],["desktop-gadgets","Desktop Gadgets","control"],["device-manager","Device Manager","devices"],["devices","Devices and Printers","devices"],["display","Display","computer"],["ease-center","Ease of Access Center","keyboard"],["folder-options","Folder Options","folder"],["fonts","Fonts","text"],["getting-started","Getting Started","windows"],["homegroup","HomeGroup","computer"],["indexing-options","Indexing Options","folder"],["infrared","Infrared","devices"],["internet-options","Internet Options","ie"],["iscsi","iSCSI Initiator","drive"],["keyboard","Keyboard","keyboard"],["location","Location and Other Sensors","system"],["mobility","Windows Mobility Center","computer"],["mouse","Mouse","cursor"],["network-sharing","Network and Sharing Center","ie"],["notification-area","Notification Area Icons","system"],["parental-controls","Parental Controls","system"],["pen-touch","Pen and Touch","devices"],["performance","Performance Information and Tools","taskmanager"],["personalization","Personalization","paint"],["phone-modem","Phone and Modem","devices"],["power-options","Power Options","system"],["programs-features","Programs and Features","folder"],["recovery","Recovery","system"],["region-language","Region and Language","system"],["remoteapp","RemoteApp and Desktop Connections","computer"],["sound","Sound","media"],["speech-recognition","Speech Recognition","system"],["sync-center","Sync Center","system"],["system","System","computer"],["tablet-settings","Tablet PC Settings","devices"],["taskbar","Taskbar and Start Menu","windows"],["troubleshooting","Troubleshooting","control"],["user-account","User Accounts","system"],["windows-anytime","Windows Anytime Upgrade","windows"],["windows-cardspace","Windows CardSpace","system"],["windows-defender","Windows Defender","system"],["windows-features","Windows Features","folder"],["firewall","Windows Firewall","system"],["windows-update","Windows Update","windows"]
...
function initControl(){
  ...
  byId("controlContent").addEventListener("click",event=>{
    ...
    const link=event.target.closest("[data-control-link]");if(link){const id=link.dataset.controlLink;if(id==="system"){window.dispatchEvent(new CustomEvent("win7:open-app",{detail:"systeminfo"}));return}if(id==="devices"){window.dispatchEvent(new CustomEvent("win7:open-app",{detail:"devices"}));return}render(id,true);return}
    ...
    if(handleSupplementalControlAction(action))return
...
export function initSystemApps(){
  initPaint();initWordPad();initSticky();initSnipping();initMedia();initControl();initDetailedTaskManager();initMinesweeper();initCharacterMap();initKeyboard();initHelp()
